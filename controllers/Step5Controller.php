...
class Step5Controller {
    ...
    public function actionIndex() {
        ...
        if (isset($_SESSION['turn']) and count($_SESSION['turn']) == 4) {
            ...
            require_once ROOT . '/views/viewStep5.php';
    ...
    private function combineCardsForOnePlayer($playerCards){
        ...
        $playerCardComb = [
            ...
            [$playerCards[0], $playerCards[1], $turn[2], $turn[3], $turn[0]],
            [$playerCards[0], $playerCards[1], $turn[3], $turn[0], $turn[1]],            
        ];
